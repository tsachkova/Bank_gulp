type Tag = 'input' | 'label' | 'fieldset' | 'input' | 'legend' | 'p' | 'select';
...
type dataHtml = {
    ...
    name?: string,
    placeholder?: string,
    nextElement?: dataHtml
}

let startHtmlData: dataHtml[] = [
